...
public class UpLoadProduct extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       SanPham san_pham=new SanPham(TenSanPham,MaDanhMuc, image, SoLuong,DonGia, GiamGia, ManHinh, CameraSau, CameraTruoc, HeDieuHanh, Cpu, BoNho, Ram, KetNoi, PinSac, MoTa);
