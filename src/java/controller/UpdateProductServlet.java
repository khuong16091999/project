...
public class UpdateProductServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       String MaSanPham=request.getParameter("ma_san_pham");
        ...
        sanPhamDAO.updateSanPham(new SanPham(Integer.parseInt(MaSanPham), TenSanPham,MaDanhMuc,image, SoLuong, DonGia, GiamGia, ManHinh, CameraSau, CameraTruoc, HeDieuHanh, Cpu, BoNho, Ram, KetNoi, PinSac, MoTa));
