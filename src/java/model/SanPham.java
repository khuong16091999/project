...
public class SanPham implements Comparable<SanPham>{
    ...
    public SanPham(String ten_san_pham, int ma_danh_muc, String hinh_anh, int so_luong, int don_gia, int giamgia, String man_hinh, String camera_sau, String camera_truoc, String he_dieu_hanh, String cpu, String bo_nho, String ram, String ket_noi, String pin_sac, String mo_ta) {
    ...
    public SanPham(int ma_san_pham, String ten_san_pham, int ma_danh_muc, String hinh_anh, int so_luong, int don_gia, int giamgia, String man_hinh, String camera_sau, String camera_truoc, String he_dieu_hanh, String cpu, String bo_nho, String ram, String ket_noi, String pin_sac, String mo_ta) {
